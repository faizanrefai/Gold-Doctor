...
- (void)createStreamer
{
    ...
    //downloadSourceField.text = @"http://www.openxcelluk.info/golf/web_services/files/20122002124958.caf";
    
    downloadSourceField.text = self.urlStr;
	...
	if (streamer.bitRate != 0.0)
	{
		...
		if (duration > 0)
		{
			[positionLabel setText:
				[NSString stringWithFormat:@"Time Played: %.0f/%.0f seconds",
					progress,
					duration]];
